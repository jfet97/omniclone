...
if(value.constructor==RegExp){const lastIndex=descriptor.value.lastIndex;descriptor.value=new RegExp(descriptor.value.source,descriptor.value.flags);Object.defineProperty(res,prop,descriptor);res[prop].lastIndex=lastIndex;return}
if(value.constructor==Promise){Object.defineProperty(res,prop,descriptor);return}
