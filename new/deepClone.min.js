...
if(obj instanceof Error){throw new TypeError(`TypeError: cannot copy Error objects`)}
...
if(value instanceof Error){throw new TypeError(`TypeError: cannot copy Error objects`)}
