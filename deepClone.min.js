...
res[prop]=realDeepCopy(value,{setPrototype,invokeConstructors});safeReferences.set(value,res[prop])}else{Object.defineProperty(res,prop,descriptor)}});return res})(obj,config,references)}
